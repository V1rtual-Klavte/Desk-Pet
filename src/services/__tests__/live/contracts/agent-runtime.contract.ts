...
export const agentRuntimeContract: ModuleContract = {
  ...
  sourceHash: "f41391b3f1e68db8f6071d401d5b1b15b866dd1e3287178b34f69101012e0379",
  coverage: [
    {
      id: "ar-01",
      feature: "生产消息入口",
    ...
    },
    {
      id: "ar-09",
      feature: "停止入口与暂停输入",
      description: "生产入口停止运行：归还清单如实、未消费输入停为已暂停、会话里不写兜底失败回复；显式继续把暂停输入按原顺序投递且正文恰好一次，全部丢弃后正文不进入对话",
