...
export const variablePoolContract: ModuleContract = {
  ...
  sourceFiles: ["src/services/agent/pi/runtime.ts", "src/services/personality/variable-pool.ts", "src/services/personality/types.ts", "src/services/reply/generator.ts"],
  generatedAt: "2026-09-10",
  sourceHash: "ef0d1679f373f9fa21bea54e1993249edc98cc27c7a49bb3b00e43b95566de5c",
  coverage: [
    ...
    { id: "vp-04", feature: "batchWriteVars 写入注册变量", description: "RUNTIME_DATA 解析后调用 batchWriteVars 写入合法 card 变量", why: "回复生成器拥有变量写入边界", depth: "deep", scenarios: ["variable-affection-praise"] },
