...
export const safetyContract: ModuleContract = {
  ...
  sourceHash: "c35dfdfc14305855b86992cfc1c7a95fe2da4e4310c2e219d297702746c448d1",
  coverage: [
    ...
    { id: "sf-03", feature: "DANGER 级别拦截确认", description: "safetyLevel=DANGER 触发用户确认弹窗；同一份参数被确认过之后放行，换一组参数重新确认；助手模式下 DANGER 的确认与授权复用由 sf-12/13/14 覆盖；测试宿主按场景声明的策略确定性应答（默认拒绝）", why: "危险操作需确认，且确认通道不得挂起", depth: "deep", scenarios: ["safety-danger", "safety-confirm-denied", "safety-confirm-approved"] },
