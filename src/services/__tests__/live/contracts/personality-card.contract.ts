...
export const personalityCardContract: ModuleContract = {
  ...
  sourceFiles: ["src/services/personality/registry.ts", "src/services/personality/loader.ts", "src/services/personality/stages-cache.ts", "src/services/tool/registry.ts"],
  generatedAt: "2026-09-24",
  sourceHash: "33df3b2122cf520decfd58e40a4e7d318cf7ba5a94662237e7dee3a18f7fb1db",
  coverage: [
    ...
    { id: "pc-09", feature: "阶段文案链路", description: "工具类别由 ToolDef.actionCategory 经 actionCategoryOf 解析（对活动注册表的一次按名查找，未知名字与已释放的 MCP/Skill 工具同形回 _default），getStagePrompt 返回当前 Card 的阶段文案（缺类别/缺缓存回退 _default）；工具状态提示的取用点就是这条链路", why: "Card 定制的工具过程语气是产品原则，链路静默变空时全套 Live Test 不容易发现", depth: "shallow", scenarios: ["stage-prompt-link"] },
