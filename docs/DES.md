...
复杂任务可通过 Plan 拆解步骤。步骤按顺序串行执行，不再有依赖/并行标注。步骤与工具状态保留检查点，恢复时不会自动重试结果未知的外部副作用。当前验证范围和未完成体验项见[未完成工作与已知缺口](plans/active/未完成工作与已知缺口.md)，不把具备 Plan 接口等同于所有任务均可无人值守完成。
